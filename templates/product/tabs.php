...
<div class="tabs" id="tabs">
  ...
  <?php elseif ($class === 'chief') : ?>
    <img class="icon composition__fruit composition__fruit--left" src="<?= get_template_directory_uri(); ?>/assets/img/icons/orange.svg" alt="<?= get_bloginfo('name'); ?>" />
  <?php endif; ?>
      ...
      <div class="tabs__select select" id="select-2">
        ...
        <div class="select__dropdown">
          <ul class="select__options">
            <?php foreach ($list as $key => $item) : ?>
              <li class="select__option tabs__btn-select" data-select="option" data-value="<?= $item['text_big'] ?? ''; ?>" data-index="<?= $key + 1; ?>" data-tab="<?= $key + 1; ?>">
