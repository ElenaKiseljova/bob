...
(function ($) {
  $(document).ready(function () {
    ...
    function ConfettiPaper(_x, _y) {
      ...
      this.rotationSpeed = Math.random() * 600 + 500;
      // this.angle = DEG_TO_RAD * Math.random() * 360;
      this.angle = DEG_TO_RAD * 360;
      this.rotation = DEG_TO_RAD * Math.random() * 720;
      this.cosA = 1.0;
      this.size = 7.0;
      this.oscillationSpeed = Math.random() * 1.5 + 0.5;
      this.xSpeed = 40.0;
      this.ySpeed = Math.random() * 100 + 40.0;
      ...
      for (var i = 0; i < 4; i++) {
        var dx = Math.cos(this.angle + DEG_TO_RAD * (i * 90 + 40));
        var dy = Math.sin(this.angle + DEG_TO_RAD * (i * 90 + 45));
        this.corners[i] = new Vector2(dx, dy * 3);
      }
      this.Update = function (_dt) {
        this.time += _dt;
        this.rotation += this.rotationSpeed * _dt * 0.8;
